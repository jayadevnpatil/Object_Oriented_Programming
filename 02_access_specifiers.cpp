...
/*
    ...
    Introduction
    -------------
    Encapsulation is one of the fundamental principles of OOPS that involves
    bundling data(attributes) and methods(functions) that operate on the data 
    into a single unit known as a class.

    Access specifiers provide encapsulation and data hiding in C++ classes, 
    which is essential for achieving the principles of Object-Oriented 
    Programming (OOP).

    Definition
    ----------
    Access specifiers in C++ are keywords used to control the access level/ 
    ...
    - They are not directly accessible from outside the class or through 
      object instances
    - Public members (methods) can be used to access private members
    - Private members are often used to hide the internal implementation 
      details of a class
    ...
    - Protected members are used when you want to allow access to derived 
      classes but not to the outside world.
...
private:
    ...
    {
        std::cout << 
            "Private function called PrivateVar: " << privateVar << std::endl;
    }
...
protected:
    ...
    // Protected member function can be called within the class and its 
    // subclasses
    void ProtectedFunction() 
    {
        std::cout << 
            "Protected function called ProtectedVar: " << protectedVar << std::endl;
    }
