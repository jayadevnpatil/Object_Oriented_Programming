...
/*
	...
	to the calling object's data members and member functions within that 
    function.
...
/*
    An object is similar to any other data type, as pointers can be defined to 
    basic data types in C++, pointers can also be defined for an object type.

    In C++, a pointer to an object is a variable that holds the memory address 
    of an object. This allows you to indirectly access and manipulate the object 
    through the pointer.
*/
...
/*  
    In C++, we can use a base class pointer to refer to objects of a derived 
    class. This is a fundamental aspect of polymorphism and allows for dynamic 
